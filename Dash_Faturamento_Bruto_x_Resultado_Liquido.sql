...
SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (508,714,811,812) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (508,714,811,812) THEN -1*LAN.VLRLANC END)/1000 RECEITA_BRUTO,
...
((SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (508,714,811,812) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (508,714,811,812) THEN -1*LAN.VLRLANC END))+
...
(
--receita liquida
((SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (508,714,811,812) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (508,714,811,812) THEN -1*LAN.VLRLANC END))+ --RECEITA BRUTA
...
(SUM((CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (508,714,811,812) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (508,714,811,812) THEN -1*LAN.VLRLANC END))))*-1)*100) CUSTO_PART_PERC,
...
((SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (508,714,811,812) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (508,714,811,812) THEN -1*LAN.VLRLANC END))+ 
(SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (534,535,536,537,538,539,540,541,544,547) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (534,535,536,537,538,539,540,541,544,547) THEN -1*LAN.VLRLANC END))))*100 MARGEM_BRUTA,


(((SUM(CASE WHEN LAN.TIPLANC='R' THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D' THEN -1*LAN.VLRLANC END))/
(SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (508,714,811,812) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (508,714,811,812) THEN -1*LAN.VLRLANC END)))*100) MARGEM_LIQ,
