...
SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (522,733,734,737,739) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (522,733,734,737,739) THEN -1*LAN.VLRLANC END) OUTRAS_REC_OPER,
SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (742,743,744,745,746,771,772,77) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (742,743,744,745,746,771,772,778) THEN -1*LAN.VLRLANC END) OUTRAS_DES_OPER,
...
(SUM(CASE WHEN LAN.TIPLANC='R' THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D' THEN -1*LAN.VLRLANC END))) EBIT,
...
(SUM(CASE WHEN LAN.TIPLANC='R' THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D' THEN -1*LAN.VLRLANC END)))EBITDA,
