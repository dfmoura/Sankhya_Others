...
SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (508,714) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (508,714) THEN -1*LAN.VLRLANC END) RECEITA_BRUTA,
SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (534,539,544,551) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (534,539,544,551) THEN -1*LAN.VLRLANC END) DEDUCOES,
...
(SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (534,539,544,551) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (534,539,544,551) THEN -1*LAN.VLRLANC END))) REC_OPER_LIQ,
...
(SUM(CASE WHEN LAN.TIPLANC='R' AND PLA.CODCTACTB IN (551) THEN 1*LAN.VLRLANC WHEN LAN.TIPLANC='D'AND PLA.CODCTACTB IN (551) THEN -1*LAN.VLRLANC END))) LUCRO_BRUTO,
...
WHEN (PLA.CODCTACTB NOT IN (458, 508, 714, 522, 534, 536, 537, 539, 541, 544, 545, 546, 551,599, 601, 603, 715, 716, 718, 721,757,758,759))
AND LAN.TIPLANC='D' THEN -1*LAN.VLRLANC 
END),3) OVER (ORDER BY TO_CHAR(LAN.DTMOV,'YYYY') ASC, TO_CHAR(LAN.DTMOV,'MM') ASC)*-1))/3*-1 AS CUSTO_FIXO_AVG_LAST_3_M,
...
WHEN (PLA.CODCTACTB NOT IN (458, 508, 714, 522, 534, 536, 537, 539, 541, 544, 545, 546, 551,599, 601, 603, 715, 716, 718, 721,757,758,759))
AND LAN.TIPLANC='D' THEN -1*LAN.VLRLANC 
END),3) OVER (ORDER BY TO_CHAR(LAN.DTMOV,'YYYY') ASC, TO_CHAR(LAN.DTMOV,'MM') ASC)*-1))/3*-1)*-1 PERC_PE
